...
from lib.common import require_auth, render_sidebar_status, is_guest
from lib import price_store as ps
from lib import symbol_resolver as sr
from lib import portfolio_history as ph
from lib import viz_theme as vt
...
def _sector_groups():
    path = Path(__file__).parent.parent / 'sectors.json'
    try:
