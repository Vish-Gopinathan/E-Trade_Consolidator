...
from lib.common import require_auth, render_sidebar_status, get_secret, is_guest
from lib import earnings_store as es
...
if 'earnings_store' not in st.session_state:
    with st.spinner('Loading earnings data…'):
        store = es.load_with_github_fallback(get_secret)
